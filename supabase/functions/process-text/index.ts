...
- **מתאריך**: תאריך ההתחלה של תקופת הנכות
  • **חפש בטבלת החלטה** בעמודת "תקופה" - התאריך שמתחיל ב"מ:" או "החל מ:"
  • דוגמה: אם בטבלה כתוב "מ: 01/09/2024" → החזר "01/09/2024"
  • **רק את התאריך עצמו** - ללא "מ:" או "החל מ"
  
- **עד תאריך**: תאריך הסיום של תקופת הנכות
  • **חפש בטבלת החלטה** בעמודת "תקופה" - התאריך שמתחיל ב"עד:" או "עד"
  • דוגמה: אם בטבלה כתוב "עד: 31/12/2024" → החזר "31/12/2024"
  • **אם כתוב "צמית" או "צמיתה" או אין תאריך סיום** → החזר null
  • **רק את התאריך עצמו** - ללא "עד:" או "עד"

...
**6. טבלת החלטות - הדבר החשוב ביותר!:**

**⚠️ כללים קריטיים לחילוץ החלטות:**

**איפה למצוא את טבלת החלטות:**
- חפש כותרת **"קביעת אחוזים רפואיים"** או **"החלטה"** או **"טבלת ליקויים"**
- זו טבלה עם עמודות: תקופה | אבחנה | סעיף ליקוי | אחוז הנכות | הערות
- **כל שורה בטבלה = החלטה אחת!**

**⚠️ הכי חשוב! הבדל בין השדות:**

1. **"אחוז הנכות"** = **רק מספר!** (10%, 20%, 30%)
   - **לעולם לא** "זמני" או "צמית" - זה שדה אחר!
   - חפש בעמודה "אחוז הנכות" או "%" או "אחוז"
   - דוגמאות: "10%", "15%", "20%", "30%"

2. **"מידת הנכות"** = **רק "זמני" או "צמית"!**
   - **לא מספר!** רק זמני/צמית
   - חפש בעמודה "הערות" או "מידת נכות"

3. **"סעיף ליקוי"** = הקוד המדויק
   - דוגמאות: "(II)(23)2()א", "(II)(3)73", "עד"
   - העתק בדיוק כמו שכתוב!

4. **"מתאריך" ו"עד תאריך"** = תאריכים מעמודה "תקופה"
   - פורמט: DD/MM/YYYY
   - אם "ואילך" → "עד תאריך": "עד להודעה חדשה"

**📋 דוגמה אמיתית מהמסמך:**
[קביעת אחוזים רפואיים]
[תקופה: מ: 01/09/2024 | אבחנה: תכיפות מתן שתן | סעיף ליקוי: (II)(23)2()א | אחוז: 10% | הערות: צמית]
[תקופה: מ: 01/01/2025 עד: 31/12/2025 | אבחנה: כאב במפרק | סעיף ליקוי: עד | אחוז: 20% | הערות: זמני]

**→ חובה להחזיר מערך JSON כזה:
[
  {
...
**חובה:**
- **"אחוז הנכות"** חייב להיות **מספר בלבד** (10%, 20%) - **לא** "זמני" או "צמית"!
- **"מידת הנכות"** חייב להיות **רק "זמני" או "צמית"** - **לא** מספר!
- **כל שורה בטבלה** = אובייקט נפרד במערך
- **"סעיף ליקוי"** = העתק בדיוק כמו שכתוב בטבלה
- אם אין תאריך סיום → "עד תאריך": "עד להודעה חדשה"

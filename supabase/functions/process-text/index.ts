...
**6. טבלת החלטות - זה הדבר החשוב ביותר!:**
- **חפש טבלה בשם "החלטות" או "טבלת החלטות"** במסמך
- טבלה זו מכילה את כל הליקויים/אבחנות עם הפרטים המלאים שלהם
- **לכל שורה בטבלת החלטות צור אובייקט נפרד:**
  • "אבחנה": התיאור הרפואי המלא (דוגמה: "תכיפות במתן שתן", "אוטם שריר הלב")
  • "סעיף ליקוי": הקוד או הסעיף (דוגמה: "410", "F43.2", "(II)(23)2()א")
  • "אחוז הנכות": אחוז הנכות **של החלטה זו בלבד** (לא הסכום הכולל!)
  • "מתאריך": תאריך תחילת תוקף החלטה זו
  • "עד תאריך": תאריך סיום תוקף החלטה זו (או "עד להודעה חדשה")
  • "מידת הנכות": "זמני" או "צמית" עבור החלטה זו
  • "הערות": הערות ספציפיות לחלטה זו

- **דוגמה לטבלת החלטות:**
  | אבחנה | סעיף | אחוז | מתאריך | עד תאריך | הערות |
  | תכיפות במתן שתן | (II)(23)2()א | 10% | 01/01/2024 | 31/12/2024 | - |
  | כאבי גב | 34א | 15% | 01/01/2024 | עד להודעה חדשה | - |
...
- **אם אין טבלת החלטות מפורשת:**
  • חפש טבלה עם ליקויים/אבחנות ואחוזים
  • צור אובייקט החלטה אחד לכל ליקוי בטבלה
  • אם יש רק אבחנה אחת - החזר מערך עם החלטה אחת

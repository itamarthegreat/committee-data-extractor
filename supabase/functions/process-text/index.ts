...
- **ת.ז:**: 
  • **חובה למצוא! חפש בכל המקומות הבאים:**
    1. **בטבלת "פרטים אישיים"** - שורה "מספר זהות:" או "זהות:"
    2. בכותרת העליונה - "זהות, מספר: XXXXXXXX"
    3. בשורה הראשונה של הטבלה - לפעמים כתוב "זהות: מספר: XXXXXXXX שם פרטי שם משפחה"
    4. חפש בכל העמוד הראשון מספר של 8-9 ספרות
  • **זה תמיד מספר של 8-9 ספרות בלבד**
  • דוגמאות נכונות: "29393154", "11327061", "123456789"
  • **לא לקחת:** מספר ועדה (NV-XXXXX), מספר תיק, טלפון, תאריך

**3. תאריכים חשובים:**
- **תאריך ועדה**: 
  • **חובה למצוא! חפש בכל המקומות הבאים:**
    1. **בטבלת "פרטים אישיים"** - שורה "תאריך הועדה:" או "תאריך ועדה:"
    2. בכותרת או בתחילת המסמך - "תאריך: DD/MM/YYYY"
    3. לפני טבלת "משתתפי הועדה" - לפעמים כתוב "תאריך:"
    4. חפש תאריך בפורמט DD/MM/YYYY בעמוד הראשון
  • דוגמה: "29/09/2025"
  • זה התאריך שבו התקיימה הועדה
  • **לא לבלבל** עם תאריך לידה או תאריך פגיעה!
...
**4. משתתפי הועדה - חשוב מאוד!:**

**⚠️ כללים קריטיים למשתתפי ועדה:**
- חפש בקטע **"משתתפי הועדה"** או **"חברי הועדה"**
- **אל תכלול מזכיר!** - רק רופאים ומומחים
- כל משתתף מופיע בשורה נפרדת עם שם ותפקיד
- **פורמטים אפשריים:**
  • "ד"ר מיכאל בלומנטל - כירורגיה אורולוגית"
  • "ד"ר יעקב ארד רפואה דחופה,רפואה פנימית"
  • "אורולוגית כירורגיה בלומנטל מיכאל ד"ר" (סדר הפוך!)

**📋 דוגמה מהמסמך:**
[משתתפי הועדה]
[שם: ד"ר יעקב ארד, תפקיד: רפואה דחופה,רפואה פנימית]
[שם: אורטל פלד, תפקיד: מזכיר הישיבה]

**→ החזר:**
- "משתתף ועדה 1": "ד"ר יעקב ארד (רפואה דחופה, רפואה פנימית)"
- "משתתף ועדה 2": null  ← כי יש רק רופא 1
- "משתתף ועדה 3": null
- "משתתף ועדה 4": null

**חובה:**
- **לא לכלול** "מזכיר הישיבה", "מזכיר ישיבה", "מזכירות"
- אם אין משתתפים → החזר null לכל 4 השדות
- פורמט: "שם מלא (תפקיד)"
...
**6. טבלת החלטות - **קריטי! חובה לחלץ את כל השורות!**

**🔴🔴🔴 חובה מוחלטת! 🔴🔴🔴**

**מצא את הטבלה "קביעת אחוזים רפואיים" - היא מכילה בדרך כלל 10-15 שורות!**

**דוגמה למסמך טיפוסי - 14 החלטות (לא 3, לא 5, אלא 14!):**

1. תסמונת התעלה הקרפלית דו צדדי | 31(4)(א) | 10% | זמני | 21/08/2018 → 31/12/2020
2. כאב במפרק הכתף ימין | 42(1)(ד)(I) | 5% | צמית | 25/05/2020 → עד להודעה חדשה
3. תסמונת התעלה הקרפלית שמאל | 31(4)(א) | 5% | צמית | 01/01/2021 → עד להודעה חדשה
4. תסמונת התעלה הקרפלית ימין | 31(4)(א) | 10% | צמית | 21/01/2021 → עד להודעה חדשה
5. אובדן שיניים | 74(1)(ד)(II) | 7.75% | צמית | 01/01/2023 → עד להודעה חדשה
6. דום נשימה בשינה | 3(ג) | 20% | צמית | 17/08/2023 → עד להודעה חדשה
7. Trigeminal neuralgia שמאל | 29(5)(א)(II) | 30% | צמית | 01/05/2024 → עד להודעה חדשה
8. תגובה לדחק חמור | 34(ב)(3) | 20% | זמני | 26/06/2024 → 31/07/2024
9. תגובה לדחק חמור | 34(ב)(3) | 20% | צמית | 01/08/2024 → עד להודעה חדשה
10. מחלת לב איסכמית | 9(1)(ב)(I) | 20% | צמית | 01/08/2024 → עד להודעה חדשה
11. תכיפות מתן שתן | 23(2)(א)(II) | 10% | צמית | 01/09/2024 → עד להודעה חדשה
12. Disturbance of salivary secretion | 73(3)(II) | 30% | צמית | 01/01/2025 → עד להודעה חדשה
13. מרפק טניס | אין נכות | 0% | - | 27/01/2025 → -
14. כאב בצוואר | 37(5)(א) | 5% | צמית | 26/03/2025 → עד להודעה חדשה

**את כל 14 ההחלטות האלה אתה חייב לחלץ! לא רק 5 מתוכן!**

**⚠️ כלל זהב: כל שורה בטבלה "קביעת אחוזים רפואיים" = החלטה אחת במערך!**

**⚠️ הבנת מבנה הטבלה:**

הטבלה נראית כך:
[קביעת אחוזים רפואיים]

תקופה: מ: 21/08/2018 עד: 31/12/2020 | אבחנה: תסמונת קרפלית דו צדדי | סעיף: 31(4)(א) | אחוז: 10% 10% | הערות: זמני
תקופה: מ: 25/05/2020 | אבחנה: כאב במפרק הכתף ימין | סעיף: 42(1)(ד)(I) | אחוז: 5% 5% | הערות: צמית
תקופה: מ: 01/01/2021 | אבחנה: תסמונת קרפלית שמאל | סעיף: 31(4)(א) | אחוז: 5% 5% | הערות: צמית

**שים לב:**
- עמודה "תקופה" יכולה להכיל:
  • "מ: DD/MM/YYYY עד: DD/MM/YYYY" → יש תאריך התחלה וסיום
  • "מ: DD/MM/YYYY" → יש רק תאריך התחלה (סיום = "עד להודעה חדשה")
- עמודה "סעיף ליקוי" מכילה קוד מלא כמו: "31(4)(א)", "42(1)(ד)(I)", "(II)(3)73"
- עמודה "אחוז הנכות" לפעמים מופיעה פעמיים (10% 10%) - **קח את המספר הראשון**
- עמודה "הערות" מכילה "זמני" או "צמית" - זו "מידת הנכות"

**⚠️ קריטי מאוד! הבנת העמודות - בדוק 3 פעמים!**

**🔴 כלל מספר 1 - חפש את הטבלה הנכונה!**
- הטבלה נקראת **"קביעת אחוזים רפואיים"** - חפש בדיוק את הכותרת הזו!
- אל תתבלבל עם טבלאות אחרות במסמך שמכילות חוות דעת בודדות
- זו הטבלה המרכזת והסופית שמכילה את כל ההחלטות במקום אחד

**🔴 כלל מספר 2 - תאריכים שונים לכל שורה!**
- **כל שורה בטבלה יכולה להיות מתקופה אחרת לחלוטין!**
- דוגמאות:
  • שורה 1: מ: 21/08/2018 עד: 31/12/2020
  • שורה 2: מ: 25/05/2020
  • שורה 3: מ: 01/01/2021
  • שורה 4: מ: 21/01/2021
- **אל תניח שכל השורות מאותה תקופה!**

**🔴 כלל מספר 3 - אחוז הנכות הוא תמיד מספר!**
- השדה "אחוז הנכות" **חייב** להכיל מספר: 5%, 10%, 15%, 20%, 25%, 30%, וכו'
- **זה אף פעם לא יכול להיות** "זמני" או "צמית" או "קבוע"!
- אם אתה רואה "זמני" או "צמית" - זה **לא** אחוז הנכות! זה "מידת הנכות"!

**איך לקרוא כל שורה בטבלה "קביעת אחוזים רפואיים":**

דוגמה לשורה מהטבלה:
[מ: 21/08/2018 עד: 31/12/2020 | תסמונת התעלה הקרפלית דו צדדי | 31(4)(א) פגיעה בעצב... | 10% 10% | זמני - סעיף מותאם]

חילוץ נכון:
1. **תקופה**: "מ: 21/08/2018 עד: 31/12/2020"
   - "מתאריך": "21/08/2018"
   - "עד תאריך": "31/12/2020"

2. **אבחנה**: "תסמונת התעלה הקרפלית דו צדדי"

3. **סעיף ליקוי**: "31(4)(א)" ← קח רק את הקוד, לא את התיאור המלא!
   - דוגמאות קודים: "31(4)(א)", "42(1)(ד)(I)", "(II)(3)73", "23(2)(א)(II)"

4. **אחוז הנכות**: "10%" ← לפעמים כתוב "10% 10%" - קח את המספר הראשון!
...
- **מידת הנכות** = זמני/צמית בלבד
- **סעיף ליקוי** = הקוד המלא מהטבלה
- **תאריכים** = כל שורה יכולה להיות מתאריך אחר!
- אם הטבלה ארוכה → **המשך עד הסוף, אל תקצר!**

...
- **אחוז הנכות**: האחוז הכולל המשוקלל הסופי
  • **סדר חיפוש (בעדיפות):**
    1. **טבלת "החלטה אחרונה מתאריך" או "החלטה רפואית מתאריך"**:
    ...
    2. **טבלה סופית** עם "נכות", "שקלול נכות", "נכות משוקלל":
       - דוגמה:
         | נכות | שקלול נכות | נכות משוקלל |
         | 30.7% | 31% | זמני |
       - **קח מעמודה "נכות"** → החזר: "30.7%"
    
    3. **טבלת החלטות רגילה** - "אחוז נכות" בטבלה עם ליקויים
  
  • **אל תוסיף** "צמית" או "זמני" לאחוז - אלה שייכים ל"מידת הנכות"
  
- **אחוז הנכות משוקלל**: השקלול לחישוב פטור ממס
  • **סדר חיפוש:**
    1. **טבלה עם "שקלול נכות"** - אם קיימת טבלה סופית עם עמודה זו:
       | נכות | שקלול נכות | נכות משוקלל |
       | 30.7% | 31% | זמני |
       → החזר: "31%"
    
    2. **אחרת** - החזר את אותו ערך כמו "אחוז הנכות" (אם אין עמודה נפרדת)
...
- **מידת הנכות**: האם הנכות זמנית או צמיתה
  • **כיצד לקבוע:**
    1. **אם יש תאריך סיום ספציפי** (כמו "31/10/2025") → "זמני"
    2. **אם כתוב "ואילך"** או "עד להודעה חדשה" → "צמית"
    3. **אם יש עמודה ספציפית** "נכות משוקלל" או "מידת הנכות" עם הערך - קח אותו

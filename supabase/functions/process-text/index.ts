...
- חפש כותרת **"קביעת אחוזים רפואיים"** או **"החלטה"**
- זו טבלה עם עמודות: תקופה | אבחנה | סעיף ליקוי | אחוז הנכות | הערות
- **כל שורה בטבלה = החלטה אחת!**

**📋 דוגמה אמיתית מהמסמך:**
[קביעת אחוזים רפואיים]
[תקופה: מ: 01/09/2024 | אבחנה: תכיפות מתן שתן | סעיף ליקוי: (II)(23)2()א | אחוז הנכות: 10% | הערות: צמית]
[תקופה: מ: 01/01/2025 | אבחנה: Disturbance of salivary | סעיף ליקוי: (II)(3)73 | אחוז הנכות: 30% | הערות: צמית]
...
[
  ...
  {
    "אבחנה": "Disturbance of salivary secretion",
    "סעיף ליקוי": "(II)(3)73",
    "אחוז הנכות": "30%",
    "מתאריך": "01/01/2025",
    "עד תאריך": "עד להודעה חדשה",
...
- אם יש "מ: XX/XX/XXXX עד: YY/YY/YYYY" → חלק לשני שדות
- אם כתוב "צמית" → "מידת הנכות": "צמית"
- אם כתוב "זמני" → "מידת הנכות": "זמני"
- אם אין טבלת החלטות → חפש טבלה עם "אבחנות" ו"אחוזים"

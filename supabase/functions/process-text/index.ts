...
- **אחוז הנכות**: האחוז הכולל המשוקלל הסופי
  • **חפש קודם את הטבלה הסופית** עם כותרות: "נכות", "שקלול נכות", "נכות משוקלל", "תאריך עד", "מתאריך"
  • **קח מהעמודה "נכות משוקלל" או "נכות"** - זה האחוז הכולל הסופי
  • דוגמה לטבלה סופית:
    | נכות | שקלול נכות | נכות משוקלל | תאריך עד | מתאריך |
    | 30.7% | 31% | זמני | 31/10/2026 | 01/11/2025 |
    → החזר אחוז הנכות: "30.7%" (מעמודה "נכות")
  • **אם לא נמצאה טבלה כזו**, חפש בטבלת החלטות רגילה תחת "אחוז נכות"
  • **אל תוסיף** את המילה "צמית" לאחוז - היא שייכת ל"מידת הנכות"
  
- **אחוז הנכות משוקלל**: השקלול לחישוב פטור ממס
  • **חפש באותה טבלה סופית** תחת "שקלול נכות"
  • דוגמה:
    | נכות | שקלול נכות | נכות משוקלל |
    | 30.7% | 31% | זמני |
    → החזר אחוז הנכות משוקלל: "31%"
  • **אם לא נמצאה טבלה כזו**, חפש בטבלה עם "התקופה" ו"הנכות הרפואית" ואז קח מהעמודה "הנכות הרפואית"
  
- **מתאריך ועד תאריך - קריטי! מהטבלה הסופית!**
  • **חפש קודם את הטבלה הסופית** עם "מתאריך", "תאריך עד", "נכות משוקלל", "נכות"
  • דוגמה לטבלה סופית:
    | נכות | שקלול נכות | נכות משוקלל | תאריך עד | מתאריך |
    | 30.7% | 31% | זמני | 31/10/2026 | 01/11/2025 |
    → מתאריך: "01/11/2025", עד תאריך: "31/10/2026"
  
  • **אם לא נמצאה טבלה כזו**, חפש טבלה עם "התקופה" ו"הנכות הרפואית":
    • **קח את השורה האחרונה בטבלה!**
    • דוגמה:
      | התקופה | הנכות הרפואית |
      | מ-18/01/2022 עד 31/08/2023 | 40.0% |
      | מ-01/09/2023 עד 31/03/2024 | 35.0% |
      | מ-01/04/2024 ואילך | 28.0% |
    • **מתאריך**: קח מהשורה האחרונה: "01/04/2024"
    • **עד תאריך**: אם כתוב "ואילך" → "עד להודעה חדשה", אחרת קח את התאריך
  
- **מידת הנכות**: האם הנכות זמנית או צמיתה
  • **חפש בטבלה הסופית** תחת "נכות משוקלל" או בעמודה נפרדת
  • דוגמה:
    | נכות | שקלול נכות | נכות משוקלל | תאריך עד | מתאריך |
    | 30.7% | 31% | זמני | 31/10/2026 | 01/11/2025 |
    → מידת הנכות: "זמני"
  • אפשרויות: "זמני", "צמית", "צמיתה"
  • **אם בטבלה כתוב "ואילך"** או אין תאריך סיום → זה "צמית"

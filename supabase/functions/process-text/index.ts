...
**6. טבלת החלטות - חובה לחלץ **כל** השורות מהטבלה "קביעת אחוזים רפואיים"!:**

**⚠️ קריטי! חפש את הטבלה עם הכותרת המדויקת: "קביעת אחוזים רפואיים"**
- זו הטבלה הסופית והמרוכזת במסמך!
- היא מופיעה בדרך כלל באמצע או בסוף המסמך
- **חלץ את כל השורות מטבלה זו בלבד!**
- אל תתבלבל עם טבלאות אחרות של חוות דעת בודדות
...
**⚠️ קריטי! זכור:**
- **חלץ **כל** השורות מהטבלה!** לא רק 2-3 דוגמאות!
- **אחוז הנכות** = מספר בלבד (10%, 20%)
- **מידת הנכות** = זמני/צמית בלבד
- **סעיף ליקוי** = הקוד מהטבלה (לא "זמני"/"צמית")
- אם הטבלה ארוכה → החזר **כל** השורות, אל תקצר!

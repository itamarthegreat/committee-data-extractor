...
**6. טבלת החלטות - **קריטי! תהליך דו-שלבי!**

**🔴🔴🔴 תהליך חובה! 🔴🔴🔴**

**שלב 1: חפש את הטבלה "קביעת אחוזים רפואיים"**
- זו הטבלה המרכזית במסמך
- היא מופיעה בדרך כלל באמצע או בסוף
- היא מכילה את כל האבחנות עם התאריכים והאחוזים

**שלב 2: ספור כמה שורות יש בטבלה לפני שאתה מתחיל לחלץ!**
- **אם ספרת 14 שורות → חלץ 14 החלטות**
- **אם ספרת 10 שורות → חלץ 10 החלטות**
- **אם ספרת 5 שורות → חלץ 5 החלטות**
- **אל תעצור באמצע! אם התחלת לחלץ, סיים את כל השורות!**

**⚠️ זכור: כל שורה בטבלה = אובייקט אחד במערך "החלטות"**

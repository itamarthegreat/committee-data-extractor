...
- **אחוז הנכות**: האחוז הכולל הסופי שנקבע (לא הנכות הרפואית!)
  • דוגמה: "10%", "25%", "50%"
...
- **אחוז הנכות משוקלל**: אחוז הנכות הרפואית (לא הנכות הכוללת!)
  • דוגמה: "28%", "35%", "40%"
  • חפש בטבלה עם כותרות כמו "התקופה" ו"הנכות הרפואית" 
  • זה האחוז שמופיע בעמודה "הנכות הרפואית"
  • **שים לב!** זה אחוז שונה מ"אחוז הנכות" הכללי
  • דוגמה לטבלה:
    | התקופה | הנכות הרפואית |
    | מ-01/04/2024 ואילך | 28.0% |
    → החזר: "28%"
  
- **מתאריך וע ד תאריך - קריטי! קח את השורה האחרונה בטבלה!**
  • **חפש את הטבלה עם "התקופה" ו"הנכות הרפואית"**
  • **קח את השורה האחרונה בטבלה** - זו התקופה הנוכחית!
  • דוגמה לטבלה:
    | התקופה | הנכות הרפואית |
    ...
    | מ-01/04/2024 ואילך | 28.0% |
  • **מתאריך**: 
    - **קח את השורה האחרונה!** במקרה זה: "01/04/2024"
    - חפש "מ-" או "מ:" ואז את התאריך
    - אם יש "ואילך" או "נמצא בקבוצת" - זה עדיין תקופה תקפה!
  • **עד תאריך**:
    - **אם בשורה האחרונה כתוב "ואילך"** → החזר "עד להודעה חדשה"
    - **אם יש תאריך ספציפי** → החזר את התאריך
    - דוגמה: "מ-01/04/2024 ואילך" → עד תאריך: "עד להודעה חדשה"
  
- **מידת הנכות**: האם הנכות זמנית או צמיתה
  • אפשרויות: "זמני", "צמית", "צמיתה"
  • **אם בטבלה כתוב "ואילך" או "נמצא בקבוצת"** → זה "צמית"

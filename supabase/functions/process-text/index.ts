...
- דוגמאות: "דוח כירורגיה אורולוגית...", "דוח נכות רפואית", "פטור ממס הכנסה"
...
**3. תאריכים חשובים:**
- **תאריך ועדה**: התאריך שבו התקיימה הועדה (חפש "תאריך ועדה", "תאריך הישיבה")
- **תאריך פגיעה**: "תאריך האירוע:" או "תאריך פגיעה:" (רק אם קיים - לאיבה ונכות מעבודה)

**4. משתתפי הועדה - חפש בקטע "משתתפי הועדה":**
...
- **שם טופס**: קבע לפי תוכן:
  • אם יש "פטור ממס" או "מס הכנסה" בכותרת = "פטור ממס"

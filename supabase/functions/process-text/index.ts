...
**6. טבלת החלטות - חובה לחלץ **כל** השורות!:**

**⚠️ חשוב מאוד! חלץ **כל** השורות מהטבלה, לא רק 2-3 דוגמאות!**
אם יש 8 שורות בטבלה → החזר 8 החלטות במערך
אם יש 15 שורות → החזר 15 החלטות

**איפה למצוא את הטבלה:**
חפש טבלה עם הכותרת **"קביעת אחוזים רפואיים"** או **"טבלת ליקויים"**
דוגמה לטבלה:

| תקופה | אבחנה | סעיף ליקוי | אחוז | הערות |
|--------|-------|------------|------|--------|
| מ: 01/01/2024 | תכיפות מתן שתן | (II)(23)2()א | 10% | צמית |
| מ: 15/02/2024 | כאב במפרק | עד | 15% | זמני |
| מ: 20/03/2024 | דום נשימה | (II)(3)73 | 30% | צמית |

**⚠️ קריטי! הבנת העמודות:**

**עמודה "תקופה"** → תחלץ ממנה 2 שדות:
- אם כתוב "מ: 01/01/2024" → "מתאריך": "01/01/2024"
- אם כתוב "עד: 31/12/2024" → "עד תאריך": "31/12/2024"
- אם אין "עד" → "עד תאריך": "עד להודעה חדשה"

**עמודה "אחוז הנכות" או "אחוז" או "%"** → זה **רק מספר**:
- דוגמאות נכונות: "10%", "15%", "20%", "30%"
- **לעולם לא**: "זמני", "צמית", "קבוע" - אלו לא אחוזים!
- אם לא מוצא מספר בעמודה → null

**עמודה "סעיף ליקוי" או "סעיף"** → קוד הליקוי:
- דוגמאות: "(II)(23)2()א", "(II)(3)73", "עד", "מותאם"
- העתק **בדיוק** כמו שכתוב בטבלה
- **זה לא** "זמני" או "צמית"!

**עמודה "הערות"** → תחלץ ממנה "מידת הנכות":
- אם כתוב "צמית" → "מידת הנכות": "צמית"
- אם כתוב "זמני" → "מידת הנכות": "זמני"
- **זה לא** מספר ולא קוד סעיף!

**⚠️ שגיאה נפוצה - אל תעשה כך:**
❌ "סעיף ליקוי": "זמני" ← שגוי! זה "מידת הנכות"!
❌ "אחוז הנכות": "צמית" ← שגוי! זה "מידת הנכות"!
❌ "אחוז הנכות": null ← שגוי! חפש את המספר בטבלה!

**📋 דוגמה - איך לקרוא שורה מהטבלה:**

שורה בטבלה:
| מ: 01/09/2024 | תכיפות מתן שתן | (II)(23)2()א | 10% | צמית |

איך לחלץ:
1. עמודה ראשונה "מ: 01/09/2024" → "מתאריך": "01/09/2024", "עד תאריך": "עד להודעה חדשה"
2. עמודה שניה "תכיפות מתן שתן" → "אבחנה": "תכיפות מתן שתן"
3. עמודה שלישית "(II)(23)2()א" → "סעיף ליקוי": "(II)(23)2()א"
4. עמודה רביעית "10%" → "אחוז הנכות": "10%"
5. עמודה חמישית "צמית" → "מידת הנכות": "צמית"

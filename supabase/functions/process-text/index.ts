    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: "system", 
            content: "Extract ALL information from Hebrew medical committee documents. Pay special attention to extract EVERY row from the 'קביעת אחוזים רפואיים' table - typically 10-15 rows. Do not stop early!"
          },
...
**6. טבלת החלטות - חלץ את כל השורות מהטבלה "קביעת אחוזים רפואיים":**

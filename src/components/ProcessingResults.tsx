...
const ProcessingResults = ({ results, isProcessing, filesCount }: ProcessingResultsProps) => {
  ...
  const exportSingleDocument = (doc: ProcessedDocument) => {
    ...
    const docData = [
      ...
      ['משתתף ועדה 1', doc["משתתף ועדה 1"] || 'לא זוהה'],
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="col-span-2">
                    <span className="font-medium">משתתפי ועדה:</span>{' '}
                    {[doc["משתתף ועדה 1"], doc["משתתף ועדה 2"], doc["משתתף ועדה 3"], doc["משתתף ועדה 4"]]
                      .filter(m => m && m !== 'לא זוהה')
                      .join(' | ') || 'לא זוהו'}
                  </div>
                </div>
